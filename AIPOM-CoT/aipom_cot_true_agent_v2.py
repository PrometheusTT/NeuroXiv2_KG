"""
AIPOM-CoT V9 FINAL COMPLETE VERSION
=====================================

This is the COMPLETE, PRODUCTION-READY version that includes:
✅ Real schema from schema.json
✅ Non-leading questions (honest testing)
✅ Complete FingerprintAnalyzer (adapted to real schema)
✅ All 6 tool functions
✅ Full statistical toolkit
✅ True replanning logic
✅ Proper morphology queries
✅ Schema-guided planning
✅ Self-reflection
✅ Dynamic adaptation

This is what should actually be used for:
