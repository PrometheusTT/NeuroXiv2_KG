"""
Baseline Methods for AIPOM-CoT Benchmark (v3.0 - Fair Comparison)
==================================================================
包含4个公平对比的baseline方法：
1. Direct GPT-4o - 强大的LLM baseline
2. Template-KG - 扩展模板库 (25+模板)
3. RAG - 智能检索 (LLM关键词提取)
4. ReAct - 动态迭代 (最多10次)

Changes in v3.0 (公平性修复):
- ✅ ReAct动态max_iterations (3-10，与AIPOM公平)
- ✅ Template-KG扩展到27个模板（覆盖闭环分析）
- ✅ RAG使用LLM智能提取关键词（替代正则）
- ✅ 所有baseline充分发挥能力
