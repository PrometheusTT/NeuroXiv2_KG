...
def main():
    ...
    # ============================================================
    FIXED_K = {
        'Morph': 16,  # Set based on your clustering exploration results
        'Gene':  29,   # Set based on your clustering exploration results
        'Proj': 25,   # Set based on your clustering exploration results
    }
