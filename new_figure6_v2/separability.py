"""
Task 2:Region Confusion Score Analysis (V2 - Fixed)
=====================================================
修正版本：
1.明确公式：Confusion Score = within / between（越低越好）
2.全局归一化：所有模态使用同一个距离尺度
3.Train/Test Split：PCA在训练集上fit，在测试集上评估
4.对等降维：多模态融合前先将各模态降到相同维度，避免维度主导
